								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= file_url('includes/img/jm_denis.jpg'); ?>" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= file_url('includes/img/chadengle.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= file_url('includes/img/mlane.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="<?= file_url('includes/img/talha.jpg'); ?>" alt="Img Profile">
												</div>
												<div class="notif-content">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img"> 
												<img src="<?= file_url('includes/img/profile2.jpg'); ?>" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?= file_url('includes/img/profile.jpg'); ?>" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar avatar-xxl">
											<img src="<?= file_url('includes/img/jm_denis.jpg'); ?>" alt="..." class="avatar-img rounded-circle">
										</div>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar">
											<img src="<?= file_url('includes/img/jm_denis.jpg'); ?>" alt="..." class="avatar-img rounded">
										</div>
								...
								<div class="card-body">
									<p class="demo">
										<div class="avatar-group">
											<div class="avatar">
												<img src="<?= file_url('includes/img/jm_denis.jpg'); ?>" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="<?= file_url('includes/img/chadengle.jpg'); ?>" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="<?= file_url('includes/img/mlane.jpg'); ?>" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
